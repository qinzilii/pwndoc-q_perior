...
async function prepAuditData(data, settings) {
    ...
    result.number = data.number || "undefined"
    result.auditName = data.auditName || "undefined"
    ...
    result.auditor_name = data.auditor_name || "undefined"
    result.auditor_position = data.auditor_position || "undifined"
    result.daily_rate = data.daily_rate || "undefined"
    result.man_hour = data.man_hour || "undefined"
    result.honorar = data.daily_rate*data.man_hour || "undefined"
    ...
    if (data.company) {
        ...
        result.company.address = data.company.address || "undefined"
        result.company.postcode = data.company.postcode || "undefined"
        result.company.city = data.company.city || "undefined"
    }
