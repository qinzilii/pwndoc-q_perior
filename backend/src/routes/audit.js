module.exports = function(app, io) {
    ...
    app.put("/api/audits/:auditId/general", acl.hasPermission('audits:update'), async function(req, res) {
        ...
        if (req.body.auditName) update.auditName = req.body.auditName;
        ...
        if (req.body.auditor_name) update.auditor_name = req.body.auditor_name;
        if (req.body.auditor_position) update.auditor_position = req.body.auditor_position;
        if (req.body.daily_rate) update.daily_rate = req.body.daily_rate;
        if (req.body.man_hour) update.man_hour = req.body.man_hour;
        if (req.body.honorar) update.honorar = req.body.honorar;
